...
public class AdmissionDeatailActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_guest_admission_deatilview);
		
		pdfbutton = (Button)findViewById(R.id.adm_button_pdf_Download);
	    
		Bundle extras = getIntent().getExtras();
		sTitle = extras.getString("title");
		sDesc =extras.getString("desc");
		linkpdf =extras.getString("pdflink_adm");
	...
	private void init() {
		...
		title = (TextView) findViewById(R.id.adm_desc_title);
		desc = (TextView) findViewById(R.id.adm_desc_detail);
