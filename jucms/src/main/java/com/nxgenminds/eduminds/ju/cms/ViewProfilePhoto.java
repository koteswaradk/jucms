...
public class ViewProfilePhoto extends ActionBarActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.custom_item_pager_image);
	...
	public void downloadImage(){
		...
		try {
			...
			Toast.makeText(ViewProfilePhoto.this, "Image Saved", Toast.LENGTH_SHORT).show();
			out.flush();
			out.close();
