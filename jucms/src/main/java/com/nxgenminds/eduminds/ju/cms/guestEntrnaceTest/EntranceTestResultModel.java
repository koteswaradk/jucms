...
public class EntranceTestResultModel {
	...
	private String entrance_test_result_id;
	...
	public String getEntrance_test_result_id() {
		return entrance_test_result_id;
	}
	public void setEntrance_test_result_id(String entrance_test_result_id) {
		this.entrance_test_result_id = entrance_test_result_id;
	}
