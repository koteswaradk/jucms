...
public class PostsAdapter extends BaseAdapter{
	...
	public PostsAdapter(Context context,ArrayList<Posts> listData){
		...
		holder.postImage.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(feedItem.getPost_type().equalsIgnoreCase("5") || feedItem.getPost_type().equalsIgnoreCase("3")){
					...
					Intent mediaIntent = new Intent(Intent.ACTION_VIEW).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
					mediaIntent.setDataAndType(Uri.parse(feedItem.getPost_video_path()), mimeType);
					System.out.println(Uri.parse("video path" + feedItem.getPost_video_path()));
	...
	static class ViewHolder{
		ImageView postUserImage,postImageOnTop;
