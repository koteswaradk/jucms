...
public class AcademicsDeatailActivity extends Activity {

	private ArrayList<AcademicsModel> model = new ArrayList<AcademicsModel>();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_guest_academic_deatilview);
