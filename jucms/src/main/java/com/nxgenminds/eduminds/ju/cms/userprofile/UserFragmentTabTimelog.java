...
import com.nxgenminds.eduminds.ju.cms.adapters.TimeLogAdapter;
...
public class UserFragmentTabTimelog extends Fragment{
	private SwipeRefreshLayout swipeLayout;
	private ListView timelogListView;
	private ProgressDialog pDialog;
	private TextView noFeed;
	private String GroupTimeFeedURL = Util.API+ "post?user_id=" + Util.USER_ID;
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		adapter = new TimeLogAdapter(getActivity(), timeLogSearch);
		timeLogSearch.clear();
		pageCount = 0;
			...
			else if(HttpGetClient.statuscode == 200)
			{
				try {
					if(result.getJSONArray("posts")== null)
					{
						...
						noFeed.setVisibility(View.VISIBLE);
						noFeed.setText("Check all your recent updates here! ");
