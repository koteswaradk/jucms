...
public class GroupTimefeedAdapter extends BaseAdapter{
	...
	public GroupTimefeedAdapter(Context context,ArrayList<Posts> listData){
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		class DeletePostAsyncTask extends AsyncTask<String, Void, Integer>{
			@Override
		...
		holder.postOptionsButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Log.i("holder.postOptionsButton", "sample");
				...
				confirmAlert.setPositiveButton("Confirm", new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						if(conn.isConnectingToInternet()){
							new DeletePostAsyncTask().execute(feedItem.getPost_id());
						} else{
