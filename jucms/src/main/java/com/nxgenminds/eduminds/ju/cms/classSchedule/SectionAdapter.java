...
public class SectionAdapter extends BaseAdapter{
	...
	private ArrayList<Sections> listData;
	private LayoutInflater layoutInflater;
	private Context prova;

	public SectionAdapter(Context context,ArrayList<Sections> listData){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		Sections sectionItem = (Sections) listData.get(position);

		Typeface typeFace=Typeface.createFromAsset(prova.getAssets(),"fonts/BentonSans-Regular.otf");
		holder.list_name.setText(sectionItem.getSection_name());
		return convertView;
	}
