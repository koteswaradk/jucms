...
public class UserFragmentTabPhotos extends Fragment{

	private GridView photoGridView;
	private TextView noPhotos;
	private String UserGalleryPhotosURL = Util.API+ "photo?user_id=" + Util.USER_ID;
	...
	public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if(conn.isConnectingToInternet()){
        	new UserGalleryPhotoAsync().execute();
        } else{
			...
			public void onScroll(AbsListView view, int firstVisibleItem,
				...
				if(firstVisibleItem+visibleItemCount == totalItemCount && totalItemCount!=0)
				{
					if(flag_loading == false)
					{
						...
						ConnectionDetector conn = new ConnectionDetector(getActivity());
			            if(conn.isConnectingToInternet()){
			            	new UserGalleryPhotoLoadMoreAsync().execute();
			            } else{
			            	alert.showAlertDialog(getActivity(),"Connection Error","Check your Internet Connection",false);
			            }
	...
	private class UserGalleryPhotoAsync extends AsyncTask<Void, Void, ArrayList<UserPhotosGalleryModel>>{
	...
	private class UserGalleryPhotoLoadMoreAsync extends AsyncTask<Void, Void, ArrayList<UserPhotosGalleryModel>>{
