...
public class UserFragmentTabVideos extends Fragment{
	...
	private String UserGalleryVideoUrl = Util.API+"video?user_id=" + Util.USER_ID;
	...
	public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if(conn.isConnectingToInternet()){
        	new UserGalleryVideoAsync().execute();
        } else{
			...
			public void onScroll(AbsListView view, int firstVisibleItem,
				...
				if(firstVisibleItem+visibleItemCount == totalItemCount && totalItemCount!=0)
				{
					if(flag_loading == false)
					{
						...
						ConnectionDetector conn = new ConnectionDetector(getActivity());
			            if(conn.isConnectingToInternet()){
			            	new UserGalleryVideoLoadMoreAsync().execute();
			            } else{
			            	alert.showAlertDialog(getActivity(),"Connection Error","Check your Internet Connection",false);
			            }
	...
	private class UserGalleryVideoAsync extends AsyncTask<Void, Void, ArrayList<UserVideoGalleryModel>>{
		...
		protected ArrayList<UserVideoGalleryModel> doInBackground(
			...
			JSONObject jsonObjectRecived = HttpGetClient.sendHttpPost(UserGalleryVideoUrl);
	...
	private class UserGalleryVideoLoadMoreAsync extends AsyncTask<Void, Void, ArrayList<UserVideoGalleryModel>>{
		...
		protected ArrayList<UserVideoGalleryModel> doInBackground(
			...
			// TODO Auto-generated method stub
			JSONArray userGalleryPhotosResponse = null;
			JSONObject jsonObjectRecived = HttpGetClient.sendHttpPost(UserGalleryVideoUrl + "&last_date=" + pagination_Date_String.replaceAll(" ", "%20"));
